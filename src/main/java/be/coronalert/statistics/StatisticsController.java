...
public class StatisticsController {
  ...
  @GetMapping("/v1/all")
  public DataHolder getAll() {
    return dataHolder;
  }

  @GetMapping("/v1/combinedHospitalisationsPerDay")
  public Set<CombinedHospitalisationsPerDay> getCombinedHospitalisationsPerDay() {
    return dataHolder.getCombinedHospitalisationsPerDay();
  }

  @GetMapping("/v1/combinedCasesPerDay")
  public Set<CombinedCasesPerDay> getCombinedCasesPerDay() {
    return dataHolder.getCombinedCasesPerDay();
  }
}
